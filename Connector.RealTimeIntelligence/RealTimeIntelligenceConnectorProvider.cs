...
namespace CluedIn.Connector.RealTimeIntelligence
{
    public class RealTimeIntelligenceConnectorProvider : ProviderBase, IExtendedProviderMetadata
    {
        ...
        public Guide Guide { get; set; } = new Guide {
            Instructions = RealTimeIntelligenceConstants.Instructions,
            Value = new List<string> { RealTimeIntelligenceConstants.ConnectorDescription },
            Details = RealTimeIntelligenceConstants.Details
